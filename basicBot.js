...
(function () {
    ...
    var basicBot = {
        ...
        chatLink: "https://rawgit.com/LuqDragon/source/master/lang/langIndex.json",
        chat: null,
        loadChat: loadChat,
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.songstats) {
                if (typeof basicBot.chat.songstatistics === "undefined") {
                    API.sendChat("/me " + lastplay.media.author + " - " + lastplay.media.title + ": " + lastplay.score.positive + "LEGAL" + lastplay.score.grabs + "ADD" + lastplay.score.negative + "CHATO")
                }
                else {
